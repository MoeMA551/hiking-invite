...
export default function DestinationCard({onRsvp}) {
  ...
  return (
    <DefaultCard onRsvp={onRsvp}>
      <div className="relative h-full w-full flex flex-col gap-1 px-6 pb-10 items-center">
        <p className="text-2xl sm:text-2xl font-bold text-cream-50 drop-shadow-[0_1px_4px_rgba(0,0,0,0.5)] align-center">
            Where To Go?
        </p>
        <p className="text-lg sm:text-xl font-bold text-cream-50 drop-shadow-[0_1px_4px_rgba(0,0,0,0.5)]align-center">
          {destination.name}
        </p>
        <p className="text-xl sm:text-xl font-bold text-cream-50 drop-shadow-[0_1px_4px_rgba(0,0,0,0.5)]align-center">
